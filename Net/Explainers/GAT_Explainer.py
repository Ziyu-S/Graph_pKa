...
if __name__ == "__main__":
    ...
    model_dir = "/Graph_pKa/Results/GAT_Grid_Search/2/saved_models/dataset_4_3/loss_MSELoss_h48_b32_lr0.01_d0.5_hd4"
    ...
    mean_importance_df.to_csv('/Graph_pKa/Results/GAT_Grid_Search/1/Feature_Importance/GAT_Feature_Importance_1.csv', index=False)
