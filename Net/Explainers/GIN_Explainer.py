...
if __name__ == "__main__":
    ...
    model_dir = "../../Results/GIN_Grid_Search/saved_models/dataset_2/loss_MSELoss_h64_b24_lr0.006_d0.3_p<function global_mean_pool at 0x7363c8dd6ca0>"
    ...
    mean_importance_df.to_csv('../../Results/GIN_Grid_Search/Feature_Importance/GIN_Feature_Importance_1.csv', index=False)
